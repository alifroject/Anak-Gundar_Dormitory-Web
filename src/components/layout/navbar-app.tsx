...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="bg-white w-full h-22 fixed top-0 left-0 flex justify-between items-center p-4 z-10 border-b border-gray-300">
                {/* Logo */}
            ...
            {isSidebarOpen && (
                <div
                    ...
                    onClick={closeSidebar} // Tutup sidebar ketika mengklik luar area sidebar
                >
                    <div
                        className="fixed top-0 left-0 w-64 h-full bg-white p-5 z-30 transition-transform transform"
                        onClick={(e) => e.stopPropagation()} // Cegah sidebar tertutup jika klik di dalam sidebar
                    >
                        <button onClick={toggleSidebar} className="text-black hover:text-gray-400 focus:outline-none">
