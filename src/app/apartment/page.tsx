            ...
            <div className="flex flex-col items-center justify-center mt-[70px] bg-gradient-to-r from-purple-50 via-white to-purple-50 p-10 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="text-purple-500 mb-6 animate-bounce">
                    <svg
                        ...
                        fill="currentColor"
                    >
                        <path d="M10 3a1 1 0 011 1v2h2a1 1 0 011 1v10a1 1 0 01-1 1H6a1 1 0 01-1-1V7a1 1 0 011-1h2V4a1 1 0 011-1h2zm0 3V4h-2v2h2zm-3 5h6v8H7V11z" />
                    </svg>
                </div>
                                    ...
                                    {kos.images[0] && (
                                        <div className="mt-auto overflow-hidden rounded-t-lg shadow-sm transition-transform transform hover:scale-105 duration-300">
                                            <img
                                                src={kos.images[0]}
                                                alt={`Gambar ${kos.name}`}
                                                className="w-full md:h-[150px] h-[200px] object-cover"
                                            />
                                        </div>
                                    )}
