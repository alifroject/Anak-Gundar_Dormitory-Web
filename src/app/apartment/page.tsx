                            ...
                            <Link href="#" onClick={handleNavigateToBooking}>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 px-4 mt-8">
                                    {filteredKos.map((kos) => (
                                        <div
                                            key={kos.id}
                                            className="flex flex-col h-full p-4 bg-gray-100 border border-gray-300 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                                        >
                                            <h2 className="text-base md:text-lg font-semibold text-gray-800 mb-2 hover:text-blue-500 transition-colors duration-300">
                                                {kos.name}
                                            </h2>
                                        ...
                                        <p>Harga per Hari: <span className="font-semibold text-green-700">{new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(selectedKos.price.perBulan)}</span></p>
                                            ...
                                            {kos.images[0] && (
                                                <div className="mt-4 overflow-hidden rounded-md shadow-md transition-transform transform hover:scale-105 duration-300">
                                                    <img
                                                        src={kos.images[0]}
                                                        alt="Gambar Kos"
